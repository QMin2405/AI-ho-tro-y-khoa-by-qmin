...
export enum ThemeId {
    ...
    SYNTHWAVE = 'SYNTHWAVE',
    HOPEFUL_SEA = 'HOPEFUL_SEA',
    FRESH_MEADOW = 'FRESH_MEADOW',
    TROPICAL_SUNSET = 'TROPICAL_SUNSET',
    PURPLE_AURORA = 'PURPLE_AURORA',
    PASTEL_DREAM = 'PASTEL_DREAM',
    LAVENDER_MINT = 'LAVENDER_MINT',
    MYSTIC_NIGHT = 'MYSTIC_NIGHT',
    REFINED_STEEL = 'REFINED_STEEL',
    PURPLE_DUSK = 'PURPLE_DUSK',
    WARM_CHOCOLATE = 'WARM_CHOCOLATE',
    MONOCHROME_MIST = 'MONOCHROME_MIST',
    EMERALD_AURORA = 'EMERALD_AURORA',
